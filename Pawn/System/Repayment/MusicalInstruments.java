...
public class MusicalInstruments implements RepaymentManager {

    @Override
    public String toString() {
        return "MusicalInstruments"; // Return the name of the loan type
    }
    ...
    public double repaymentCalculator(double loan_amount, int duration) {
        ...
        // Annual interest rate (15%) // I declare it here because It should be local in this method
        double annualRate = 0.15/12;
